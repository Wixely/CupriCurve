...
/// <summary>
/// Constant-time scalar arithmetic modulo the group order L, transcribed from the public-domain
/// ref10 (djb) <c>sc_reduce</c> / <c>sc_muladd</c> routines. Scalars are represented internally as
/// twelve signed 21-bit limbs. There are no secret-dependent branches or memory accesses.
///
/// The reduction constants (666643, 470296, 654183, 997805, 136657, 683901) encode
/// L = 2^252 + 27742317777372353535851937790883648493.
/// </summary>
internal static class ScRef10
{
    private static long Load3(ReadOnlySpan<byte> b, int o) =>
        (long)b[o] | ((long)b[o + 1] << 8) | ((long)b[o + 2] << 16);

    private static long Load4(ReadOnlySpan<byte> b, int o) =>
        (long)b[o] | ((long)b[o + 1] << 8) | ((long)b[o + 2] << 16) | ((long)b[o + 3] << 24);

    private const long M = 2097151; // 2^21 - 1

    /// <summary>Reduce a 64-byte little-endian value modulo L into 32 bytes.</summary>
    internal static void Reduce(ReadOnlySpan<byte> s, Span<byte> outb)
    {
        long s0 = M & Load3(s, 0);
        long s1 = M & (Load4(s, 2) >> 5);
        long s2 = M & (Load3(s, 5) >> 2);
        long s3 = M & (Load4(s, 7) >> 7);
        long s4 = M & (Load4(s, 10) >> 4);
        long s5 = M & (Load3(s, 13) >> 1);
        long s6 = M & (Load4(s, 15) >> 6);
        long s7 = M & (Load3(s, 18) >> 3);
        long s8 = M & Load3(s, 21);
        long s9 = M & (Load4(s, 23) >> 5);
        long s10 = M & (Load3(s, 26) >> 2);
        long s11 = M & (Load4(s, 28) >> 7);
        long s12 = M & (Load4(s, 31) >> 4);
        long s13 = M & (Load3(s, 34) >> 1);
        long s14 = M & (Load4(s, 36) >> 6);
        long s15 = M & (Load3(s, 39) >> 3);
        long s16 = M & Load3(s, 42);
        long s17 = M & (Load4(s, 44) >> 5);
        long s18 = M & (Load3(s, 47) >> 2);
        long s19 = M & (Load4(s, 49) >> 7);
        long s20 = M & (Load4(s, 52) >> 4);
        long s21 = M & (Load3(s, 55) >> 1);
        long s22 = M & (Load4(s, 57) >> 6);
        ...
        Store(outb, s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11);
    }

    /// <summary>Compute (a*b + c) mod L for 32-byte little-endian inputs.</summary>
    internal static void MulAdd(ReadOnlySpan<byte> a, ReadOnlySpan<byte> b, ReadOnlySpan<byte> c, Span<byte> outb)
    {
        long a0 = M & Load3(a, 0);
        long a1 = M & (Load4(a, 2) >> 5);
        long a2 = M & (Load3(a, 5) >> 2);
        long a3 = M & (Load4(a, 7) >> 7);
        long a4 = M & (Load4(a, 10) >> 4);
        long a5 = M & (Load3(a, 13) >> 1);
        long a6 = M & (Load4(a, 15) >> 6);
        long a7 = M & (Load3(a, 18) >> 3);
        long a8 = M & Load3(a, 21);
        long a9 = M & (Load4(a, 23) >> 5);
        long a10 = M & (Load3(a, 26) >> 2);
        long a11 = Load4(a, 28) >> 7;

        long b0 = M & Load3(b, 0);
        long b1 = M & (Load4(b, 2) >> 5);
        long b2 = M & (Load3(b, 5) >> 2);
        long b3 = M & (Load4(b, 7) >> 7);
        long b4 = M & (Load4(b, 10) >> 4);
        long b5 = M & (Load3(b, 13) >> 1);
        long b6 = M & (Load4(b, 15) >> 6);
        long b7 = M & (Load3(b, 18) >> 3);
        long b8 = M & Load3(b, 21);
        long b9 = M & (Load4(b, 23) >> 5);
        long b10 = M & (Load3(b, 26) >> 2);
        long b11 = Load4(b, 28) >> 7;

        long c0 = M & Load3(c, 0);
        long c1 = M & (Load4(c, 2) >> 5);
        long c2 = M & (Load3(c, 5) >> 2);
        long c3 = M & (Load4(c, 7) >> 7);
        long c4 = M & (Load4(c, 10) >> 4);
        long c5 = M & (Load3(c, 13) >> 1);
        long c6 = M & (Load4(c, 15) >> 6);
        long c7 = M & (Load3(c, 18) >> 3);
        long c8 = M & Load3(c, 21);
        long c9 = M & (Load4(c, 23) >> 5);
        long c10 = M & (Load3(c, 26) >> 2);
    ...
    private static void Store(Span<byte> s, long s0, long s1, long s2, long s3, long s4, long s5,
